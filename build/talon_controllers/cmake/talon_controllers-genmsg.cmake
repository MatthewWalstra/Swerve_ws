...
get_filename_component(_filename "/home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/src/talon_controllers/srv/PidfSlot.srv" NAME_WE)
add_custom_target(_talon_controllers_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "talon_controllers" "/home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/src/talon_controllers/srv/PidfSlot.srv" ""
)
...
_generate_srv_cpp(talon_controllers
  "/home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/src/talon_controllers/srv/PidfSlot.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/talon_controllers)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/talon_controllers\")")
  # install generated code
  install(
