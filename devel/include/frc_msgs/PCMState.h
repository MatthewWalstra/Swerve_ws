...
bool operator==(const ::frc_msgs::PCMState_<ContainerAllocator1> & lhs, const ::frc_msgs::PCMState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.name == rhs.name &&
    lhs.pcm_id == rhs.pcm_id &&
    lhs.enabled == rhs.enabled &&
    lhs.pressure_switch == rhs.pressure_switch &&
    lhs.compressor_current == rhs.compressor_current &&
    lhs.closed_loop_control == rhs.closed_loop_control &&
    lhs.current_too_high == rhs.current_too_high &&
    lhs.current_too_high_sticky == rhs.current_too_high_sticky &&
    lhs.shorted == rhs.shorted &&
    lhs.shorted_sticky == rhs.shorted_sticky &&
    lhs.not_connected == rhs.not_connected &&
    lhs.not_connected_sticky == rhs.not_connected_sticky &&
    lhs.voltage_fault == rhs.voltage_fault &&
    lhs.voltage_sticky_fault == rhs.voltage_sticky_fault &&
    lhs.solenoid_blacklist == rhs.solenoid_blacklist;
}
