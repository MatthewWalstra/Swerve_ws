...
bool operator==(const ::frc_msgs::RobotControllerData_<ContainerAllocator1> & lhs, const ::frc_msgs::RobotControllerData_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.fpgaVersion == rhs.fpgaVersion &&
    lhs.fpgaRevision == rhs.fpgaRevision &&
    lhs.fpgaTime == rhs.fpgaTime &&
    lhs.userButton == rhs.userButton &&
    lhs.isSysActive == rhs.isSysActive &&
    lhs.isBrownedOut == rhs.isBrownedOut &&
    lhs.inputVoltage == rhs.inputVoltage &&
    lhs.inputCurrent == rhs.inputCurrent &&
    lhs.voltage3V3 == rhs.voltage3V3 &&
    lhs.current3V3 == rhs.current3V3 &&
    lhs.enabled3V3 == rhs.enabled3V3 &&
    lhs.faultCount3V3 == rhs.faultCount3V3 &&
    lhs.voltage5V == rhs.voltage5V &&
    lhs.current5V == rhs.current5V &&
    lhs.enabled5V == rhs.enabled5V &&
    lhs.faultCount5V == rhs.faultCount5V &&
    lhs.voltage6V == rhs.voltage6V &&
    lhs.current6V == rhs.current6V &&
    lhs.enabled6V == rhs.enabled6V &&
    lhs.faultCount6V == rhs.faultCount6V &&
    lhs.canData == rhs.canData;
}
