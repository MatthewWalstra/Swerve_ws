...
bool operator==(const ::frc_msgs::RobotControllerCANData_<ContainerAllocator1> & lhs, const ::frc_msgs::RobotControllerCANData_<ContainerAllocator2> & rhs)
{
  return lhs.percentBusUtilization == rhs.percentBusUtilization &&
    lhs.busOffCount == rhs.busOffCount &&
    lhs.txFullCount == rhs.txFullCount &&
    lhs.receiveErrorCount == rhs.receiveErrorCount &&
    lhs.transmitErrorCount == rhs.transmitErrorCount;
}
