...
bool operator==(const ::frc_msgs::CubeState_<ContainerAllocator1> & lhs, const ::frc_msgs::CubeState_<ContainerAllocator2> & rhs)
{
  return lhs.clamp == rhs.clamp &&
    lhs.intake_high == rhs.intake_high &&
    lhs.intake_low == rhs.intake_low &&
    lhs.has_cube == rhs.has_cube;
}
