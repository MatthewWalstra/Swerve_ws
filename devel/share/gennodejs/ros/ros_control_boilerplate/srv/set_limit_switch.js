...
class set_limit_switchRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('target_joint_name')) {
        this.target_joint_name = initObj.target_joint_name
      }
      else {
        this.target_joint_name = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [target_joint_name]
    bufferOffset = _serializer.string(obj.target_joint_name, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [target_joint_name]
    data.target_joint_name = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.target_joint_name.length;
    return length + 7;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.target_joint_name !== undefined) {
      resolved.target_joint_name = msg.target_joint_name;
    }
    else {
      resolved.target_joint_name = ''
    }
...
module.exports = {
  ...
  md5sum() { return 'aea7656fc087d7bb28bae4c37dc4edcd'; },
