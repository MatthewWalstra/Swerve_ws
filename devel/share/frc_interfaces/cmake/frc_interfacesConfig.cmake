...
if("TRUE" STREQUAL "TRUE")
  set(frc_interfaces_SOURCE_PREFIX /home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/src/frc_interfaces)
  set(frc_interfaces_DEVEL_PREFIX /home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/devel)
  ...
  set(frc_interfaces_INSTALL_PREFIX /home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/install)
...
if(NOT "/home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/src/frc_interfaces/include " STREQUAL " ")
  set(frc_interfaces_INCLUDE_DIRS "")
  set(_include_dirs "/home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/src/frc_interfaces/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'frc_interfaces' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/matthew-walstra/Rover_Nano_Swerve/Swerve_ws/src/frc_interfaces/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT frc_interfaces_NUM_DUMMY_TARGETS)
      set(frc_interfaces_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::frc_interfaces::wrapped-linker-option${frc_interfaces_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR frc_interfaces_NUM_DUMMY_TARGETS "${frc_interfaces_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::frc_interfaces::wrapped-linker-option${frc_interfaces_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND frc_interfaces_LIBRARIES "${interface_target_name}")
