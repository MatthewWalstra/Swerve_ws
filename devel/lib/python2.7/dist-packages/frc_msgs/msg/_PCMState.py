...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.pressure_switch = list(map(bool, self.pressure_switch))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.closed_loop_control = list(map(bool, self.closed_loop_control))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.current_too_high = list(map(bool, self.current_too_high))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.current_too_high_sticky = list(map(bool, self.current_too_high_sticky))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.shorted = list(map(bool, self.shorted))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.shorted_sticky = list(map(bool, self.shorted_sticky))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.not_connected = list(map(bool, self.not_connected))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.not_connected_sticky = list(map(bool, self.not_connected_sticky))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.voltage_fault = list(map(bool, self.voltage_fault))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.voltage_sticky_fault = list(map(bool, self.voltage_sticky_fault))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
