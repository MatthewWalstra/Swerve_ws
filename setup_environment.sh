...
mkdir -p /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/include 
mkdir -p /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/lib/ctre 
cd /home/matthew-walstra 
...
cd /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/include 
find /home/matthew-walstra/devsite.ctr-electronics.com -name \*headers\*zip | xargs -n 1 unzip -o 
cd /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/lib/ctre 
find /home/matthew-walstra/devsite.ctr-electronics.com -name \*linux\*zip | xargs -n 1 unzip -o 
rm -rf /home/matthew-walstra/devsite.ctr-electronics.com 
cd /home/matthew-walstra 
...
mkdir -p /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/include/navx 
cd /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/include/navx 
unzip -o /home/matthew-walstra/navx-cpp-3.1.400-headers.zip 
rm /home/matthew-walstra/navx-cpp-3.1.400-headers.zip 
cd /home/matthew-walstra 
wget http://www.kauailabs.com/maven2/com/kauailabs/navx/frc/navx-cpp/3.1.400/navx-cpp-3.1.400-linuxathena.zip 
mkdir -p /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/lib/navx 
cd /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/lib/navx 
unzip -o /home/matthew-walstra/navx-cpp-3.1.400-linuxathena.zip 
rm /home/matthew-walstra/navx-cpp-3.1.400-linuxathena.zip 
cd /home/matthew-walstra 
wget http://www.kauailabs.com/maven2/com/kauailabs/navx/frc/navx-cpp/3.1.400/navx-cpp-3.1.400-linuxathenastatic.zip 
cd /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/lib/navx 
unzip -o /home/matthew-walstra/navx-cpp-3.1.400-linuxathenastatic.zip 
rm /home/matthew-walstra/navx-cpp-3.1.400-linuxathenastatic.zip 
...
cd /home/matthew-walstra 
wget https://github.com/wpilibsuite/allwpilib/releases/download/v2020.3.2/WPILib_Linux-2019.3.2.tar.gz 
mkdir -p /home/matthew-walstra/wpilib/2020 
cd /home/matthew-walstra/wpilib/2020 
tar -xzf /home/matthew-walstra/WPILib_Linux-2020.3.2.tar.gz 
rm /home/matthew-walstra/WPILib_Linux-2020.3.2.tar.gz 
cd /home/matthew-walstra/wpilib/2020/tools 
python3 ToolsUpdater.py 
mkdir -p /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/lib/wpilib 
cd /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/lib/wpilib 
find ../../../.. -name \*athena\*zip | xargs -n1 unzip -o 
mkdir -p /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/include/wpilib 
cd /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/include/wpilib 
find ../../../.. -name \*headers\*zip | xargs -n1 unzip -o 
rm -rf /home/matthew-walstra/wpilib/2020/maven /home/matthew-walstra/wpilib/2020/jdk
sed -i -e 's/   || defined(__thumb__) \\/   || defined(__thumb__) \\\n   || defined(__aarch64__) \\/' /home/matthew-walstra/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/include/wpilib/FRC_FPGA_ChipObject/fpgainterfacecapi/NiFpga.h
...
#echo "source /home/matthew-walstra/2019Offseason/zebROS_ws/command_aliases.sh" >> /home/matthew-walstra/.bashrc
